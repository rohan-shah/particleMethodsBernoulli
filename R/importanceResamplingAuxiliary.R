importanceResamplingAuxiliary <- function(nBernoullis, lowerBound, probability, probabilities, n, seed)
{
	...
	start <- Sys.time()
	result <- .Call("importanceResamplingAuxiliary", lowerBound, probabilities, n, seed, PACKAGE="particleMethodsBernoulli")
	end <- Sys.time()
