importanceResamplingWithoutReplacement <- function(nBernoullis, lowerBound, probability, probabilities, n, seed)
{
	...
	start <- Sys.time()
	result <- .Call("importanceResamplingWithoutReplacement", lowerBound, probabilities, n, seed, PACKAGE="particleMethodsBernoulli")
	end <- Sys.time()
